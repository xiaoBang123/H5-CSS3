...
arr.push('</dt>');}
function dd_push(arr,data){arr.push('<dd class="carditems_list_dd">');arr.push('<h3 class="carditems_list_h3">'+data.wap_title+'</h3> ');arr.push('<h4 class="carditems_list_h4 ">'+data.intro+'</h4>');arr.push('<p class="carditems_list_op">');arr.push('<span class="op_ico time_num fl">'+data.date+'</span>');if(data.link.indexOf('weibo.com')!=-1||data.link.indexOf('weibo.cn')!=-1){arr.push('<span class="op_sole_tips fr">微博</span>');}
else if(data.comment==''||data.comment=='0'||data.comment==0){}
else{arr.push('<span class="op_ico num_ico fr">'+data.comment+'</span>');}
...
arr.push('</p>');arr.push('</dd>');}
function dd_push2(arr,data){arr.push('<dd class="carditems_list_dd">');arr.push('<h3 class="carditems_list_h3">'+data.wap_title+'</h3>');arr.push('<h4 class="carditems_list_h4 hide">'+data.intro+'</h4>');arr.push('<p class="carditems_list_op">');arr.push('<span class="op_ico time_num fl">'+data.date+'</span>');if(data.link.indexOf('weibo.com')!=-1||data.link.indexOf('weibo.cn')!=-1){arr.push('<span class="op_sole_tips fr">微博</span>');}
else if(data.comment==''||data.comment=='0'||data.comment==0){}
else{arr.push('<span class="op_ico num_ico fr">'+data.comment+'</span>');}
if(data.isDujia==1||data.isDujia=='1'){arr.push('<span class="op_sole_tips fr">独家</span>');}
else if(data.isSubject==1||data.isSubject=='1'){arr.push('<span class="op_sub_tips fr">专题</span>');}
...
setTimeout(function(){navMore(navMoreConfig);if($('#j_imgSwipe').length>0){imgSwipe('j_imgSwipe');}
picsHeightManager.init();fastMode(fastModeConfig);navScroll(navScrollConfig)
